...
const Header = () => {
  return (
    <div className='
    flex items-center justify-between max-sm:flex-col-reverse gap-y-10 px-4 mt-10 lg:px-44 sm:mt-20'>
        {/*........ left side........ */}
        <div>
           ...
           Remove the <br className='max-md-hidden' /> <span className='bg-gradient-to-r from-violet-600 to-fuchsia-500 bg-clip-text text-transparent'>background</span> from <br className='max-md-hidden' /> images for free.
            ...
            <p className='my-6 text-[15px] text-gray-500'>Lorem ipsum dolor, sit amet consectetur adipisicing elit. <br className='max-sm-hidden' /> Explicabo non cumque adipisci consequatur debitis repellat quaerat fuga ex dolorum expedita.</p>
            <div>
